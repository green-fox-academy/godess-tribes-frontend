...
export class NotificationsComponent implements OnInit {
  ...
  createNotification(building: Building): Notification {
    if (building.level === 1) {
      ...
      return new Notification(building.buildingTypeENUM, building.level, 'Leveling up from ' + (building.level - 1) + ' to ' + building.level, building.startedAt, building.finishedAt);
    }
  }
