...
export const MAINICONS: MainIcon[] = [
    {type: 'townhall', imageURL: 'assets/images/building.png', itemNumber: 0},
    {type: 'barrack', imageURL: 'assets/images/barrak.png', itemNumber: 0},
